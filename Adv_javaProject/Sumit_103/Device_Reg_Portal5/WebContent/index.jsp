...
<header style="
  ...
  <a style="text-decoration:none; float: right; margin-left:20px;" href="prep_reg_form.htm" >Register</a>
  <a style="text-decoration:none; float: right;" href="prep_log_form.htm" >Login</a></option>
  </header>
